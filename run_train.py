...
from src.reclib.utils import get_dataloaders, get_handler
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--device",
        type=str,
        default=os.getenv("RECSYS_DEVICE"),
        help="Device to use for training.",
    )
    parser.add_argument(
        "--seq_length",
        type=int,
        default=os.getenv("RECSYS_SEQ_LENGTH"),
    ...
    parser.add_argument(
        ...
        type=int,
        default=128,
        help="Hidden length for BERT4Rec.",
    )
    parser.add_argument(
        "--batch_size",
        type=int,
        default=32,
        help="Batch length for training.",
    )
    parser.add_argument(
        "--epochs",
        type=int,
